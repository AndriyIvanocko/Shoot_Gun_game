...
public class LevelScreenThree implements Screen{
    ...
    public void render(float delta) {
        ...
        if(touchControl.isFindPosition()){
            game1.setScreen(new VictoryGameOver(game1));
        }
    }
